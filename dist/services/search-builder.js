  ...
  this.perform = function (associationName) {
    ...
    _.each(fields, function (field) {
      ...
      if (field.field === schema.idField) {
        ...
        } else if (primaryKeyType instanceof DataTypes.UUID && params.search.match(REGEX_UUID)) {
        ...
        if (model.rawAttributes[field.field] && model.rawAttributes[field.field].type instanceof DataTypes.UUID) {
          ...
          if (['HasOne', 'BelongsTo'].indexOf(association.associationType) > -1) {
            ...
            _.each(fieldsAssociation, function (field) {
              ...
              if (field.field === schemaAssociation.idField) {
                ...
                if (modelAssociation.rawAttributes[field.field] && modelAssociation.rawAttributes[field.field].type instanceof DataTypes.UUID) {
                  if (params.search.match(REGEX_UUID)) {
                    condition = opts.sequelize.where(column, '=', params.search);
                    hasExtendedConditions = true;
                  }
